...
conn = Connection(username="root", password="123")

#db = conn.createDatabase(name="ProjectDB")

db = conn["ProjectDB"]

print(db)

#ArticlesCollection = db.createCollection(name="Articles")
#Debug
